function Approach({tic, content, heading}: {tic: boolean, content: string[], heading: string}){
    return <div className="border-2 border-dashed  h-auto w-full md:w-[460px] px-5 py-8 lg:px-10 border-[#FFACAC] rounded-[20px] flex items-center  flex-col ">
        <div className="flex items-center justify-center">
            <div className="bg-[#FFFFFF] text-center rounded-[68px] px-[34px] py-[4px] text-[#242424] text-[16px] font-semibold leading-[31px] shadow-md shadow-[#0000001F] blur-[12%] ">{heading}</div>
        </div>
