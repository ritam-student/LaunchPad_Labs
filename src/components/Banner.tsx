...
function Banner() {
    return <div className="bg-[#FFFFFF] py-6 md:py-8 lg:py-10 h-auto w-full flex items-center justify-center flex-col ">
        ...
        <div className="my-16 w-[60%] h-auto relative flex items-center justify-center ">
